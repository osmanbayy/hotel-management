...
export const Footer = () => {
  ...
  return (
    <div className="pt-20 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-y-10 md:grid-cols-3 px-3 lg:grid-cols-4 text-center mt-20 mb-10">
      ...
      <div className="w-full h-[1px] bg-gray-400"></div>
      <div className="flex px-3 md:flex-row flex-col items-center justify-between my-5">
